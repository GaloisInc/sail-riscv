...
import LeanRV32DExecutable.PreludeMemAddrtype
import LeanRV32DExecutable.PreludeMemMetadata
import LeanRV32DExecutable.PreludeMem
import LeanRV32DExecutable.RiscvTypes
import LeanRV32DExecutable.RiscvVmemTypes
...
import LeanRV32DExecutable.RiscvAddrChecks
import LeanRV32DExecutable.RiscvSysControl
import LeanRV32DExecutable.RiscvPlatform
...
def is_aligned_bits (vaddr : (BitVec (2 ^ 2 * 8))) (width : word_width) : Bool :=
  match width with
  | BYTE => true
...
/-- Type quantifiers: k_ex133097# : Bool, k_ex133096# : Bool, k_ex133095# : Bool -/
...
/-- Type quantifiers: k_ex133103# : Bool, k_ex133102# : Bool, k_ex133101# : Bool -/
...
/-- Type quantifiers: k_ex133110# : Bool, k_ex133109# : Bool, k_ex133108# : Bool, k_ex133107# : Bool, width
...
/-- Type quantifiers: k_ex133130# : Bool, k_ex133129# : Bool, k_ex133128# : Bool, k_ex133127# : Bool, width
  : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133140# : Bool, k_ex133139# : Bool, k_ex133138# : Bool, k_ex133137# : Bool, width
  : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133195# : Bool, k_ex133194# : Bool, k_ex133193# : Bool, k_ex133192# : Bool, width
  : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133198# : Bool, k_ex133197# : Bool, k_ex133196# : Bool, width : Nat, 0 <
...
/-- Type quantifiers: k_ex133201# : Bool, k_ex133200# : Bool, k_ex133199# : Bool, width : Nat, 0 <
  width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133204# : Bool, k_ex133203# : Bool, k_ex133202# : Bool, width : Nat, 0 <
  width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133219# : Bool, k_ex133218# : Bool, k_ex133217# : Bool, width : Nat, 0 <
  width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133233# : Bool, k_ex133232# : Bool, k_ex133231# : Bool, width : Nat, 0 <
  width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133246# : Bool, k_ex133245# : Bool, k_ex133244# : Bool, width : Nat, 0 <
  width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133249# : Bool, k_ex133248# : Bool, k_ex133247# : Bool, width : Nat, 0 <
  width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex133252# : Bool, k_ex133251# : Bool, k_ex133250# : Bool, width : Nat, 0 <
  width ∧ width ≤ max_mem_access -/
