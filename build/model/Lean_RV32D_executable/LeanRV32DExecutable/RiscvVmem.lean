...
import LeanRV32DExecutable.RiscvTypesExt
...
import LeanRV32DExecutable.RiscvMem
import LeanRV32DExecutable.RiscvVmemPte
import LeanRV32DExecutable.RiscvVmemPtw
import LeanRV32DExecutable.RiscvVmemTlb
...
/-- Type quantifiers: k_ex134004# : Bool, level : Nat, k_ex134002# : Bool, k_ex134001# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex134048# : Bool, k_ex134047# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex134069# : Bool, k_ex134068# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex134105# : Bool, k_ex134104# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
