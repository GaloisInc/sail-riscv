...
def pmpMatchEntry (addr : physaddr) (width : (BitVec (2 ^ 2 * 8))) (acc : (AccessType Unit)) (priv : Privilege) (ent : (BitVec 8)) (pmpaddr : (BitVec (2 ^ 2 * 8))) (prev_pmpaddr : (BitVec (2 ^ 2 * 8))) : SailM pmpMatch := do
