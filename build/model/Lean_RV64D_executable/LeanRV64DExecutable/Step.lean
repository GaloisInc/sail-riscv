...
import LeanRV64DExecutable.StepCommon
import LeanRV64DExecutable.StepExt
import LeanRV64DExecutable.DecodeExt
import LeanRV64DExecutable.Fetch
...
/-- Type quantifiers: k_ex89083# : Bool, step_no : Int -/
    ...
    (do
      ...
      | .F_Base w =>
        (do
          ...
          bif ((← (is_landing_pad_expected ())) && (not (is_lpad_instruction instruction)))
          then
            (do
              let r ← do
                (pure (Trap
...
/-- Type quantifiers: k_ex89133# : Bool, step_no : Nat, 0 ≤ step_no -/
