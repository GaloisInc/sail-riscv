...
/-- Type quantifiers: k_ex88166# : Bool, level : Nat, k_ex88164# : Bool, k_ex88163# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex88211# : Bool, k_ex88210# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex88232# : Bool, k_ex88231# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex88268# : Bool, k_ex88267# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
