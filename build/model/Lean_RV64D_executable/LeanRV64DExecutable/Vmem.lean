...
/-- Type quantifiers: k_ex93095# : Bool, level : Nat, k_ex93093# : Bool, k_ex93092# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex93140# : Bool, k_ex93139# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex93161# : Bool, k_ex93160# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex93197# : Bool, k_ex93196# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
