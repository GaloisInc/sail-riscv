...
```
cmake -S . -B build -DCMAKE_BUILD_TYPE=RelWithDebInfo -DSAIL_MODULES="postlude;Zicbom_insts;Zicboz;Zicsr_insts;Zkr" && cmake --build build --target generated_lean_executable_rv64d
```
